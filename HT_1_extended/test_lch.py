...
while 1:
    ...
    for part_of_speech in ('n', 'v', 'a'):          #цикл прохода по всем частям речи (noun, verb, adjective)
        ...
        my_list = [synset1.lch_similarity(synset2) for synset1 in synsets1 for synset2 in synsets2]
